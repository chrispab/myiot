...
<div class="row">
  <div class="col-md-6">
    <h4 id="titlechart1" class="text-center">{{$settings['zone']}} - {{$hours}} hours -ALL graphs</h4>
    <div id="chart1" class="text-center"></div>
    <h6 class="text-center" id="totalsampleschart1" style="display: inline-block" >Samples: {{count($samples)}}</h6>
  ...
  <div class="col-md-6">
    <h4 id="titlechart2" class="text-center">{{$settings['zone']}} - {{$hours}} hours -ALL graphs</h4>
    <div id="chart2" class="text-center"></div>
    <h6 class="text-center" id="totalsampleschart2" style="display: inline-block" >Samples: {{count($samples)}}</h6>
